...
class ModeTests(TestCase):
    ...
    def test_document_readability_adds_warm_paper_and_blue_handwriting(self) -> None:
        ...
        image = Image.new("RGB", (360, 240), (214, 214, 214))
        draw = ImageDraw.Draw(image)
        draw.text((28, 24), "PRINTED HEADER", fill=(18, 18, 18))
        draw.line((28, 64, 330, 64), fill=(24, 24, 24), width=2)
        draw.line((28, 122, 330, 122), fill=(24, 24, 24), width=2)
        draw.line((54, 94, 112, 82, 178, 96, 238, 84, 304, 100), fill=(28, 34, 118), width=4, joint="curve")
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            paper_region = result[150:220, 42:320].astype(np.float32)
